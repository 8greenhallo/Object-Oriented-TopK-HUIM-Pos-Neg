...
public class UtilityList {
     ...
     * 
     * IMPORTANT: This method creates the utility list even if it might be pruned later.
     * This matches the original algorithm's behavior where utility lists are created
    ...
    public UtilityList join(UtilityList other) {
        ...
        // Return null only if truly empty (no matching transactions)
