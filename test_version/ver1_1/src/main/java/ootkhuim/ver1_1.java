...
/**
 * Main class for PTK-HUIM-U± algorithm - OOP Framework Version 1.1
 * 
 ...
 * - Non-parallel version for clarity and debugging
 * 
...
public class ver1_1 {
    ...
    /**
     * Main entry point for the PTK-HUIM-U± algorithm.
     * 
    ...
    private static void executeMining(String databaseFile, String profitFile, 
        ...
        System.out.println(String.format("K: %d, MinPro: %.4f", k, minProbability));
        System.out.println(String.format("Available memory: %d MB", maxMemory / 1024 / 1024));
        System.out.println(String.format("Available processors: %d", processors));
        System.out.println();
        ...
        Configuration config = new Configuration.Builder()
            ...
            .setMemoryCheckInterval(10)    // Check memory every 10 items processed
            .enableAdvancedPruning(true)
            .enableEarlyTermination(false) // DISABLE to match original ver1_1 behavior
    ...
    private static void printHeader() {
        ...
        System.out.println("PTK-HUIM-U± : Parallel Top-K High-Utility Itemset Mining");
        System.out.println("           from Uncertain Databases with Positive and Negative Utilities");
        System.out.println();
        System.out.println("Version 1.1 - Object-Oriented Framework (Non-Parallel)");
        System.out.println("Suitable for academic research and publication");
        System.out.println();
    ...
    public static void runDemo() {
        try {
            System.out.println("Running PTK-HUIM-U± Demo...");
