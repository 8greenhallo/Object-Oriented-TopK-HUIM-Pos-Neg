...
import engine.MiningEngine;

import java.io.*;
import java.util.*;

/**
 * OOTK-HUIM-U±: Top-K High-Utility Itemset Mining from Uncertain Databases
...
public class ver2 {
    ...
    public static void main(String[] args) throws IOException {
        if (args.length != 4) {
            System.err.println("Usage: ver2 <database_file> <profit_file> <k> <min_probability>");
            System.err.println();
            ...
            System.err.println("  java ver2.ver2 database.txt profits.txt 10 0.1");
            System.exit(1);
        }
    ...
    private static void displayResults(List<Itemset> topK, int k) {
        ...
        System.out.println("Rank | Itemset | Expected Utility | Existential Probability");
        System.out.println("-----|---------|------------------|------------------------");
        ...
        for (Itemset itemset : topK) {
            ...
            System.out.printf("%4d | %-7s | %16.4f | %23.4f\n", 
                            rank++, 
                            items.toString(),
