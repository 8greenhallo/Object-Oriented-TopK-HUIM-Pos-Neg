package ootkhuimunpnu.ver01;

import ootkhuimunpnu.ver01.core.*;
import ootkhuimunpnu.ver01.engine.*;
...
public class ver01 {
    ...
    private static final String ALGORITHM_NAME = "OOTK-HUIM-UN-PNU";
    ...
    private static void exportResults(List<Itemset> results, CommandLineArgs cmdArgs, MiningEngine engine) 
        ...
        // Export main results
        String outputFile = cmdArgs.outputFile != null ? cmdArgs.outputFile : "ootkhuimunpnu_results.txt";
    ...
    private static void printUsageAndExit() {
        ...
        System.out.println("  -o, --output <file>      Output file for results (default: ootkhuimunpnu_results.txt)");
