...
public class ver01 {
    ...
    private static void exportResults(List<Itemset> results, CommandLineArgs cmdArgs, MiningEngine engine) 
        ...
        // Export main results
        String outputFile = cmdArgs.outputFile != null ? cmdArgs.outputFile : "ootkhuimunpn_results.txt";
    ...
    private static void printUsageAndExit() {
        ...
        System.out.println("  -o, --output <file>      Output file for results (default: ootkhuimunpn_results.txt)");
