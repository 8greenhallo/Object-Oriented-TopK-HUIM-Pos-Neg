package ootkhuimunpnu.ver01_2;

import ootkhuimunpnu.ver01_2.engine.*;
import ootkhuimunpnu.ver01_2.core.*;
import java.io.*;
import java.util.*;

/**
 * Main class for OOTK-HUIM-UN-PNU algorithm Version 1.1
 * 
...
public class ver01_2 {
    ...
    /**
     * Main entry point for the OOTK-HUIM-UN-PNU algorithm.
     * 
    ...
    private static void printHeader() {
        ...
        System.out.println("OOTK-HUIM-UN-PNU algorithm : Object-Oriented Top-K High-Utility Itemset Mining in UNcertain database with both Positive and Negative Utilities");
    ...
    public static void runDemo() {
        try {
            System.out.println("Running OOTK-HUIM-UN-PNU Demo...");
